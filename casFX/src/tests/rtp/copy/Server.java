...
public class Server extends JFrame implements ActionListener {
	...
	private int rtpDestPort = 5004;		// destination port for RTP packets (given by the RTSP Client)
	...
	private static String videoName; // = "2014-11-22_ORF_BINGO_Edith-Oma.mp4";			// video file requested from the client
...
//			System.out.println("Server Port: " + rtspPort);
...
//		}
		...
		server.clientIp = InetAddress.getByName("127.0.0.1");;
