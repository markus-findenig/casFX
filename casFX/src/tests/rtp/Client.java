...
public class Client {
	...
	// ------------------
	//TODO 
	static int MJPEG_TYPE = 34; // RTP payload type for MJPEG video

	static int RTSP_server_port = 8554;
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (state == INIT) {
				...
				try {
					...
					// RTPsocket = ...
					DatagramSocket serverSocket = new DatagramSocket(RTSP_server_port);
