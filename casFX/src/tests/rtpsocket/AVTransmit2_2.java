...
public class AVTransmit2_2 {
    ...
    public AVTransmit2_2(MediaLocator locator,
			 String ipAddress,
			 String pb,
			 Format format) {
		...
		if (supported.length > 0) {
			...
			chosen = checkForVideoSizes(tracks[i].getFormat(), 
		    ...
		    } else if (format instanceof AudioFormat)
                    {
                        ...
                        chosen = new AudioFormat(AudioFormat.ULAW_RTP, 8000, 8, 1);
                        audioTrack = true;
                    }
                    else
                    {
		    ...
		    atLeastOneTrack = true;
                    if (audioTrack)
                    {
                       try
                        ...
                        {
                            System.err.println("exception caught: " + u.getMessage());
                        }
                    }
		} else
	...
	//   java AVTransmit2 file:/C:/media/test.mov  129.130.131.132 42050
    	// file:/D:/Users/Videos/Test/TheSimpsonsMovie1080pTrailer.avi 127.0.0.1 8554
